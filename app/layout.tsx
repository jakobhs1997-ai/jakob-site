    ...
    >
      <body className="min-h-full flex flex-col">
        ...
        <footer className="mt-auto border-t border-[var(--color-border)] bg-transparent">
          <div className="mx-auto max-w-5xl px-6 py-6 text-center sm:px-8 lg:px-12">
            <a
              href="https://linkedin.com/in/jeycup/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="inline-flex items-center justify-center w-10 h-10 mx-auto rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-[var(--color-background)]"
            >
